...
#include "../../../../../../src/ros_logger/src/swri_console/include/swri_console/node_click_handler.h"
...
void swri_console::NodeClickHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<NodeClickHandler *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject swri_console::NodeClickHandler::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_swri_console__NodeClickHandler.data,
    qt_meta_data_swri_console__NodeClickHandler,
    qt_static_metacall,
    nullptr,
    nullptr
} };
